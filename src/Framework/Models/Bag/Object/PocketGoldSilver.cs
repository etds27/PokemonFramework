...
{
    internal class PocketGoldSilver : IPocketObject
    {
        public PocketGoldSilver(PocketType pocketType, long memoryAddress, int value) : base(pocketType, memoryAddress, value)
        {
        }
